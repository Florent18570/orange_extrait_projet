...
<form method="POST" action="tampon.php">
    ...
    <?php $pos = strpos($_GET["result_deroulant"], "CAFF");
    // Si dans le résult déroulant il y a la chaine de caractère CAFF return 1 sinon return 0
    if ($pos == 0) {
        // echo "pas caff";
    } else { ?>
        <form method="POST" action="tampon.php">
            <input type="hidden" id="caff" name="caff" value="caff">
    ...
    $sql20 = "SELECT * FROM `fiche_nav_etat_habilitation` WHERE  `Application` = 'GDP'  AND  `CUID`='" . $_SESSION['Identifiant'] . "'  ";
    //echo $sql20;
    ...
    <div class="columns">
        <div class="column is-3">
            <table class="table is-responsive" style="margin-left: 40%;margin-bottom: 100px">
                <thead>
                    <tr>
                        <th><label for="countries" class="required">Base GDP</label></th>
                        <th><label for="department" class="required">Nom Base GDP:</label></th>
                    </tr>
                </thead>
                ...
                <tr>
                    ...
                    <td>
                        <input id="Nom_Base_GDP" name="Nom_Base_GDP" />
                        
                    </td>
                </tr>
                <tr>
                    <th><label for="countries" class="required">Code Groupe</label></th>
                    <th><label for="department" class="required">Groupe Autorisation</label></th>
                </tr>
                ...
                <td>
                    <input id="groupe_autorisation" name="groupe_autorisation" readOnly="readOnly" />
                </td>
        </div>
    </div>
...
<?php } 
    ...
    <div class="column is-1" style="margin-left: 16%">
        <input name="button" id="button" type="button" onclick="myFunction();" value="+">
    </div>
        ...
        <div class="container">
            <div class="text" id="text">
                <table class="table is-responsive" style="margin-left: 10%;margin-bottom: 100px">
                    ...
                    <tr>
                        <td>
                            <input class="button" class="table is-responsive" id="gdp2" name="base_gdp2" readOnly="readOnly" />
                        </td>

                        <td>
                            <input id="gdp2_message" name="Nom_Base_GDP2" readOnly="readOnly" />
                        </td>
                    ...
                    <td>
                        <input id="groupe_autorisation2" name="Groupe_autorisation2" readOnly="readOnly" />
                    </td>
                </table>
            </div>
        </div>
