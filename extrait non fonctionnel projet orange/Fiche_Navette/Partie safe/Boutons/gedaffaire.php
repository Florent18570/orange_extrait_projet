...
<form name="formulaire" method="POST" action="tampon.php">
    <input type="hidden" name="tampon" value="GEDAFFAIRE">
    <input type="hidden" name="Application" value="GEDAFFAIRE">
    ...
    <input type="hidden" name="Informations_Complémentaires_RSI" value="Informations_Complémentaires_RSI">
    ...
    if ($_POST['information'] != "historique") { ?>
        ...
        <table class="table is-responsive" style="margin-left: 10%;margin-bottom: 100px">
            ...
            <tr>
                <td>
                    <label class="required">Demande d'habilitation</label>
                </td>
                <td>
                    <select name="Demande_habilitation">
                        <option value="Super_Utilisateur">Super Utilisateur</option>
                        <option value="Chargé_affaire">Chargé d'affaire</option>
                    </select>
                </td>
            </tr>
        ...
        $sql20 = "SELECT * FROM `fiche_nav_gedaffaire` WHERE `CUID`= '" . $_SESSION['Identifiant'] .  "' ";
        // echo $sql20;
        $result20 = $bdd->query($sql20);

        $sql21 = "SELECT * FROM `fiche_nav_etat_habilitation` WHERE `Application`= 'GEDAFFAIRE' and `CUID`= '" . $_SESSION['Identifiant'] .  "' ";
        // echo $sql21;
        ...
        ?>
            ...
            <?php
            $sql11 = "SELECT `id_habilitation` FROM `fiche_nav_etat_habilitation` WHERE `Application`= 'GEDAFFAIRE' AND `CUID`= '" . $_SESSION['Identifiant'] .  "' ";
            // echo $sql11;
