...
<form name="formulaire" method="POST" action="tampon.php">
    ...
    <input type="hidden" name="tampon" value="PHARAON">
    <input type="hidden" name="Application" value="PHARAON">
    ...
    <?php if ($_POST['information'] != "historique") { ?>
        ...
        $sql20 = "SELECT * FROM `fiche_nav_PHARAON` WHERE `CUID`= '" . $_SESSION['Identifiant'] .  "' ";
        // echo $sql20;
        $result20 = $bdd->query($sql20);

        $sql21 = "SELECT * FROM `fiche_nav_etat_habilitation` WHERE `Application`= 'PHARAON' and `CUID`= '" . $_SESSION['Identifiant'] .  "' ";
        // echo $sql21;
        ...
        ?>
            ...
            $sql11 = "SELECT `id_habilitation` FROM `fiche_nav_etat_habilitation` WHERE `Application`= 'PHARAON' AND `CUID`= '" . $_SESSION['Identifiant'] .  "' ";
            // echo $sql11;
